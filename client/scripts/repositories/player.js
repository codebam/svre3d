...
export class PlayerInfo {
    ...
    static interact(act = true) {
        ...
        // entityDirection.y = 5;
        const raycaster = new THREE.Raycaster(new THREE.Vector3(this.entity.object3d.position.x, this.entity.object3d.position.y, this.entity.object3d.position.z), entityDirection, 0, maxDistance);
        const interactable = [];
