        ...
        React.createElement("div", { className: "hud-top-left", style: {
            ...
            React.createElement("div", { className: "title" },
                variables.selectedItem.type == 'entity' ?
                    React.createElement("div", { className: "preview-entity" },
                        React.createElement(Cube, { size: 15, gloom: true }))
                    :
                        React.createElement("div", { className: "preview-chunk" },
                            React.createElement(Cube, { size: 15, gloom: false, color: variables.selectedItem.chunk.biome.map.color })),
                variables.selectedItem.type == 'entity' ?
